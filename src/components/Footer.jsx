  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Filings & Press Releases', subitems: [] },
        { name: 'News & Events', subitems: [] },
        { name: 'Corporate Governance', subitems: [] },
      ...
      <div className="footer-container">
            ...
            <div key={section.id} className="footer-section">
              <div className="footer-section-header">
                {section.expandable ? (
                  ...
                  <h3 className="section-title-static">{section.title}</h3>
                )}
              </div>

              {/* Investor Relations Links (always visible) */}
              {section.id === 'investor' && (
                <ul className="footer-links investor-links">
                  {section.links.map((link, index) => (
                    <li key={index}>
                      <a href={`#${link.name.toLowerCase().replace(/\s+/g, '-')}`}>
                        {link.name}
                      </a>
                    </li>
                  ))}
              ...
              {section.expandable && expandedSections[section.id] && (
                <ul className="footer-links">
                  {/* Add your links here for each section */}
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">© 2025 Paytm</p>
